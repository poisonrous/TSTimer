...
const User = () => {
  ...
  const handleSaveInfo = async (password) => {
    ...
    try {
      const response = await fetch(`${backendUrl}/api/user/update-info`, {
        method: 'PUT',
  ...
  const handleSaveContact = async (password) => {
    ...
    try {
      const response = await fetch(`${backendUrl}/api/user/update-contact`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(updatedUser),
        credentials: 'include',
  ...
  const handleSavePassword = async (password) => {
    ...
    try {
      const response = await fetch(`${backendUrl}/api/user/update-password`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(updatedUser),
        credentials: 'include',
